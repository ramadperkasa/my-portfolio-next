    ...
    <div className="w-screen" id="collaborate">
      <div className="mx-auto my-36 h-full max-w-screen-2xl px-12 ">
        <div className="flex h-full w-full flex-col  justify-center gap-2 text-start">
            <span className="text-3xl md:text-7xl font-extrabold text-primary">
          ...
          <div className="mt-12 flex flex-col gap-5">
            ...
            >
              <Image
                ...
                height={50}
              />
              <span className="text-base md:text-2xl">ramadwiyantara1@gmail.com</span>
            </a>
            <a
            ...
            >
              <Image
                ...
                height={45}
              />
              <span className="text-base md:text-2xl">+62 889 7175 3162</span>
            </a>
          </div>
        </div>
      </div>
