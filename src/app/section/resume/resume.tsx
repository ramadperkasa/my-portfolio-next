...
function Resume() {
  ...
  const experience = [
    ...
    },
    {
      ...
      location: 'Bandung',
      description:
        'Bangkit is a unique career readiness program led by Google and delivered with support from industry experts from like Gojek, GoTo and Google',
      detail: [
      ...
      technology: ['Kotlin', 'Mobile Application Development', 'REST API'],
    },
    {
      id: '5',
  ...
  return (
    <div className='h-screen w-screen' id='resume'>
      <div className='h-full'>
        <div className='mx-auto h-full max-w-screen-2xl px-12 py-16'>
          ...
          <div className='h-full py-12 md:flex'>
            <ul className='flex-column space-y h-full space-y-4 text-sm font-medium md:mb-0 md:me-4'>
              {data.map((item) => {
                return (
                  <li key={item.id}>
                    <span
            ...
            <div className='text-medium h-full w-full overflow-auto rounded-lg bg-[#1E2023] p-6 text-gray-500 dark:bg-gray-800'>
